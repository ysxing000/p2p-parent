<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="auditmanage_detail">
			<li class=""><a href="/realAuth">实名认证审核</a></li>
			<li class=""><a href="/vedioAuth">视频认证审核</a></li>
			<li class=""><a href="/userFileAuth">认证材料审核</a></li>
			<li class=""><a href="/bidrequest_publishaudit_list">发标前审核</a></li>
			<li class=""><a href="/bidrequest_audit1_list">满标一审</a></li>
			<li class=""><a href="/bidrequest_audit2_list">满标二审</a></li>
			<li class=""><a href="/rechargeOffline">线下充值审核</a></li>
			<li class=""><a href="/moneyWithdraw">提现审核</a></li>
			<li class=""><a href="/moneyWithdraw_translist">提现转账确认</a></li>
		</ul>
	</li>
	<li class="list-group-item">
